...
// Original Code Made by: Omar Santiago
// https://github.com/omarvision/how-todo-marching-cubes
...
public static class Marching_Cubes
{
    //grid of points
    ...
    public static void SetMesh(ref Mesh mesh)
    {
        ...
        mesh.vertices = Marching_Cubes.vertices.ToArray();
        mesh.triangles = Marching_Cubes.triangles.ToArray();
        mesh.uv = Marching_Cubes.uv.ToArray();
